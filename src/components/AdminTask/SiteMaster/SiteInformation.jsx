...
const SiteInformation = () => {
  ...
  return (
    <div  className=' flex flex-col  gap-2 py-2 px-2 justify-start items-start mt-1 h-screen ' >
        <h4 className="dark:text-white  text-[#4884C0] pl-4  text-lg font-medium">Site Information BaseLine</h4>
        ...
        <div className='pb-4 px-8' >
            <div>
                <button  type="button"   className="flex dark:text-white dark:bg-[#263238] bg-white text-black  items-center justify-end w-full py-4 font-medium text-left text-black-500 rounded-t-xl ">
                    <AddSiteInformation />
