...
<div className='py-8  w-full pt-10' >
        <div className='dark:text-white dark:bg-[#263238] bg-white text-black'>
            <button  type="button"className="flex  items-center justify-between  w-full p-4 font-medium text-left text-black-500 rounded-t-xl ">
