...
const StateTable = () => {
  ...
  const { isFetching : listFetch } = useQuery('stateList',stateList.bind(this,stateFilter),{ onSuccess : (x)=> { setTotal(x?.totalCount)}})
  ...
  return (
    <>
        ...
        <div  className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
            <div>
                <label className="block mb-2 text-sm text-gray-600 dark:text-black">File no.</label>
            ...
            <div>
                <label className="block mb-2 text-sm text-gray-600 dark:text-black">Name of Person</label>
            ...
            <div>
                <label className="block mb-2 text-sm text-gray-600 dark:text-black">Incident Place</label>
        ...
        <div className="pt-16 w-full px-4 overflow-x-auto  sm:rounded-lg">
                                ...
                                <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700"  >
                                    {
                                        item.getVisibleCells().map((subItem,index)=>(
                                            <td key={index + 1} className="px-6 py-4">
                                                {
                                                    flexRender(
