...
const ReportsHvac = () => {
  ...
  return (
    <div    className=' flex flex-col  gap-2 py-2 px-2 justify-start items-start mt-1   h-screen ' >
        <h4 className="dark:text-white  text-black pl-4 pb-2 mt-8  text-lg font-medium">Energy Detail Search</h4>
            <div className=' flex flex-col lg:flex-row justify-between items-center  gap-2 w-full dark:text-white dark:bg-[#263238] bg-white text-black  py-8  ' >
                <div className='px-6' >
                    ...
                    <select  className="block w-full px-5 py-3 mt-2 text-black placeholder-gray-400  border border-black rounded-md dark:placeholder-gray-600 dark:bg-white dark:text-black dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" >
                ...
                <div className='px-6' >
                    ...
                    <input type="date" name='email'   placeholder="" className="block w-full px-5 py-3 mt-2 text-black placeholder-gray-400  border border-black rounded-md dark:placeholder-gray-600 dark:bg-white dark:text-black dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
...
<div className='py-8 w-full pt-10' >
        <div>
            <button  type="button" className="flex  items-center justify-between dark:text-white dark:bg-[#263238] bg-white text-black  w-full p-4 font-medium text-left text-black-500 rounded-t-xl ">
                <div onClick={collapseHandler} className='flex gap-2' >
                    <BsSpeedometer2 className='text-white text-3xl' />
                    <p className='text-xl text-white ' > Energy Details</p>
                </div>
