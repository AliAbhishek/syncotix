...
const DeviceAqi = () => {
    ...
    const [ deviceAqiFilter, setDeviceAqiFilter ] = useState({
        sortOrder : "",
        sortDirection : "",
        filterby : "",
        pageNo : 1,
    ...
    const { refetch : aqiFetch } = useQuery(['deviceAqiList', deviceAqiFilter],deviceAqiList.bind(this,deviceAqiFilter),{ onSuccess : (x)=> {
        setData(x?.items);
    ...
    const previousHandler = async() =>{
        if (deviceAqiFilter.pageNo === 1) return;
        setDeviceAqiFilter(old => ({
            ...old,
            pageNo: +old.pageNo - 1
        }))
...
return (
    <div  className=' flex flex-col  gap-2 py-2 px-2 justify-start items-start mt-1 h-screen ' >
        <h4 className="dark:text-white  text-[#4884C0] pl-4  text-lg font-medium">Device AQI</h4>
                ...
                </button>
                {
                    ...
                    <div className="relative overflow-x-auto ">
                        ...
                        <div className="flex justify-end items-center gap-4  mt-4">
                            ...
                            <div>
                                Page {deviceAqiFilter.pageNo} - {maxPages}
                            </div>
                        </div>
                    </div>
