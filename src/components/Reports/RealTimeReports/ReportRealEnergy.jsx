...
const ReportRealEnergy = () => {
  ...
  return (
    <div className=' flex flex-col  gap-2 py-2 px-2 justify-start items-start mt-1   h-screen  ' >
        <h4 className="dark:text-white  text-black pl-4 pb-2 mt-8  text-lg font-medium">Energy Details Search</h4>
            <div className=' flex dark:text-white  dark:bg-[#263238] bg-white  flex-col lg:flex-row justify-between items-center  gap-2 w-full text-white py-8' >
                <div className='px-6' >
                ...
                <div className='px-6' >
                    <label className="block mb-2 text-sm  ">Form Date</label>
                ...
                <button  className="flex dark:text-white dark:bg-[#263238] bg-white text-black items-center justify-between mt-8 px-6 text-sm h-10  capitalize transition-colors duration-300 transform  rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
...
<div className='py-8 w-full pt-10 ' >
        <div>
            <button  type="button" className="flex dark:text-white dark:bg-[#263238] bg-white text-black items-center justify-between w-full p-4 font-medium text-left text-black-500 rounded-t-xl ">
                <div onClick={collapseHandler} className='flex gap-2' >
                    <BsSpeedometer2 className=' text-3xl' />
                    <p className='text-xl  ' > Energy Details</p>
                </div>
...
export default ReportRealEnergy