...
import { hvacReport } from '../../../utills/api/Reports'

const ReportRealHvac = () => {
    ...
    const { data : data , isLoading : isLoading, error : error } = useQuery('hvacReport',hvacReport.bind(this,3))
  ...
  return (
    ...
    <h4 className=" dark:text-slate-200 text-[#4884C0] text-lg font-medium pb-4">Real Time Temperature-HVAC</h4>
